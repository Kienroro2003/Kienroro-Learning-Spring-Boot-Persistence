...
insert into view (name, author_id, id) values ( "A History of Ancient Prague", 4, 1);
insert into view (name, author_id, id) values ( "A People's History", 4, 2);
insert into view (name, author_id, id) values ( "History Day", 4, 3);
insert into view (name, author_id, id) values ( "The Beatles Anthology", 1, 4);
insert into view (name, author_id, id) values ( "Carrie", 2, 5);
insert into view (name, author_id, id) values ( "House Of Pain", 2, 6);
insert into view (name, author_id, id) values ( "Anthology 2000", 5, 7);
